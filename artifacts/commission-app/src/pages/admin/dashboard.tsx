    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Company-wide overview of orders, revenue, and commissions.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Company Team</CardTitle>
        ...
        <Card className="col-span-1">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Latest orders submitted across the company</CardDescription>
            </div>
        ...
        <Card className="col-span-1">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Latest commissions generated</CardDescription>
            </div>
                  ...
                  {summary.recentCommissions.map(comm => (
                    <TableRow key={comm.id}>
                      <TableCell>
                        ...
                        <div className="text-xs text-muted-foreground">{comm.roleType}</div>
                      </TableCell>
